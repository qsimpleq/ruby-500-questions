...
### Общие вопросы
   ...
   1. Какие принципы программирования вы знаете и какие из них вы пытаетесь соблюдать чаще всего?
      ...
      * **SOLID**: При создании программных систем использование этих принципов\
        ...
        * O - Принцип открытости/закрытости (Open/Closed Principle, OCP):\
              Простая для изменения система должна\
              предусматривать простую возможность изменения ее поведения добавлением нового,\
        ...
        * L - Принцип подстановки Барбары Лисков (Liskov Substitution Principle, LSP):\
              Для создания программных систем из\
        ...
        * I - Принцип интерфейсов (Interface Segregation Principle, ISP):\
              избегайте в зависимостях всё, что не используется\
        ...
        * D - Принцип инверсии зависимостей (Dependency Inversion Principle, DIP):\
              Код, реализующий высокоуровневую политику,\
              не должен зависеть от кода, реализующего низкоуровневые детали.\
   ...
   4. Что такое полиморфизм? Приведите пример использования полиморфизма.
      <details><summary>ответ</summary>
   ...
   5. Что такое паттерн/шаблон проектирования?\
